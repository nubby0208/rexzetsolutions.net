 ...
 * @since 1.0.0
 */
class Source_Custom_Local extends Source_Base {
	...
	public function pix_import_single_template($url){
    ...
    // $test = new Source_Custom_Local();
    // $res = $test->pix_import_single_template('http://localhost/new9/test.json');
