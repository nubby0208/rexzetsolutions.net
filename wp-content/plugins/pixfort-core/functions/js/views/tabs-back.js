(function ( $ ) {
	...
	if(vc.shortcode_view){
	    ...
	    window.VcBackendTtaViewInterfacePixfort = vc.shortcode_view.extend({
	            sortableSelector: !1,
	            $sortable: !1,
	            $navigation: !1,
	            ...
	            initialize: function(params) {
	                window.VcBackendTtaViewInterfacePixfort.__super__.initialize.call(this, params), _.bindAll(this, "updateSorting")
	            },
	            render: function() {
	                return window.VcBackendTtaViewInterfacePixfort.__super__.render.call(this), this.$el.addClass("vc_tta-container vc_tta-o-non-responsive"), this
	            },
	            setContent: function() {
	            ...
	            buildSortable: function($element) {
	                return !("edit" === vc_user_access().getState("shortcodes") || !vc_user_access().shortcodeAll("pix_content_tab")) && $element.sortable({
	            ...
	            updateSorting: function(event, ui) {
	                var self;
	                if (!vc_user_access().shortcodeAll("pix_content_tab")) return !1;
	            ...
	            changedContent: function(view) {
	                var changedContent = window.VcBackendTtaViewInterfacePixfort.__super__.changedContent.call(this, view);
		...
		window.VcBackendTtaTabsViewPixfort = window.VcBackendTtaViewInterfacePixfort.extend({
	            ...
	            changeActiveSection: function(modelId) {
	                window.VcBackendTtaTabsViewPixfort.__super__.changeActiveSection.call(this, modelId), this.$navigation.children("." + this.activeClass).removeClass(this.activeClass), this.findNavigationTab(modelId).addClass(this.activeClass)
	            },
	            notifySectionRendered: function(model) {
	                var $element, title, $insertAfter, clonedFrom;
	                window.VcBackendTtaTabsViewPixfort.__super__.notifySectionRendered.call(this, model), title = model.getParam("title"), $element = $(this.getParsedNavigationSectionTemplate({
