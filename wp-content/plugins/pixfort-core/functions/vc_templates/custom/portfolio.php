...
function pix_templates_portfolio(){
    ...
    $data['name'] = __( 'Portfolio carousel Services', 'pixfort-core' ); // Assign name for your custom template
    ...
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/portfolio/services-portfolio-carousel.png'; // Always use preg replace to be sure that "space" will not break logic. Thumbnail should have this dimensions: 114x154px
...
CONTENT;
    ...
    $data = array(); // Create new array
    $data['name'] = __( 'Portfolio Construction', 'pixfort-core' ); // Assign name for your custom template
    $data['weight'] = 0; // Weight of your template in the template list
    $data['type'] = 'default_templates'; // Weight of your template in the template list
    $data['category'] = 'default_templates'; // Weight of your template in the template list
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/portfolio/construction-portfolio.png'; // Always use preg replace to be sure that "space" will not break logic. Thumbnail should have this dimensions: 114x154px
    $data['custom_class'] = 'custom_template_for_vc_custom_template all portfolio'; // CSS class name
    $data['content']  = <<<CONTENT
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Portfolio carousel Personal', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/portfolio/personal-portfolio.png';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Portfolio Photography', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/portfolio/photography-portfolio.png';
    $data['custom_class'] = 'custom_template_for_vc_custom_template all portfolio';
    $data['content']  = <<<CONTENT
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Portfolio carousel 3 Agency', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/portfolio/agency-portfolio-3.png';
    $data['custom_class'] = 'custom_template_for_vc_custom_template all portfolio';
    $data['content']  = <<<CONTENT
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Portfolio carousel 2 Agency', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/portfolio/agency-portfolio-2.png';
    $data['custom_class'] = 'custom_template_for_vc_custom_template all portfolio';
    $data['content']  = <<<CONTENT
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Portfolio Slides', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/portfolio/slides-portfolio.png';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Portfolio Main Original', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/portfolio/original-main-portfolio.png';
    $data['custom_class'] = 'custom_template_for_vc_custom_template all portfolio';
    $data['content']  = <<<CONTENT
