...
//     $data['name'] = __( 'Schedule Event', 'pixfort-core' ); // Assign name for your custom template
...
//     $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/video/event-schedule.png';
