...
function pix_templates_sliders(){
    ...
    $data['name'] = __( 'Slider Bold', 'pixfort-core' ); // Assign name for your custom template
    ...
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/sliders/bold-intro.png';
...
CONTENT;
    ...
    $data = array(); // Create new array
    $data['name'] = __( 'Slider Creative', 'pixfort-core' ); // Assign name for your custom template
    $data['weight'] = 0; // Weight of your template in the template list
    $data['type'] = 'default_templates'; // Weight of your template in the template list
    $data['category'] = 'default_templates'; // Weight of your template in the template list
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/sliders/creative-intro.png';
    $data['custom_class'] = 'custom_template_for_vc_custom_template all sliders intros'; // CSS class name
    $data['content']  = <<<CONTENT
...
CONTENT;
    ...
    $data = array(); // Create new array
    $data['name'] = __( 'Slider Ecommerce', 'pixfort-core' ); // Assign name for your custom template
    $data['weight'] = 0; // Weight of your template in the template list
    $data['type'] = 'default_templates'; // Weight of your template in the template list
    $data['category'] = 'default_templates'; // Weight of your template in the template list
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/sliders/ecommerce-intro.png';
    $data['custom_class'] = 'custom_template_for_vc_custom_template all sliders intros'; // CSS class name
    $data['content']  = <<<CONTENT
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Slider Foundation', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/sliders/foundation-intro.png';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Slider Construction', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/sliders/construction-intro.png';
    $data['custom_class'] = 'custom_template_for_vc_custom_template all sliders intros';
    $data['content']  = <<<CONTENT
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Image slider Construction', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/sliders/construction-image-slider.png';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Slider Business', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/sliders/business-intro.png';
    $data['custom_class'] = 'custom_template_for_vc_custom_template all sliders intros';
    $data['content']  = <<<CONTENT
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Slider Photography', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/sliders/photography-intro.png';
    $data['custom_class'] = 'custom_template_for_vc_custom_template all sliders intros';
    $data['content']  = <<<CONTENT
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Slider Beauty', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/sliders/beauty-intro.png';
    $data['custom_class'] = 'custom_template_for_vc_custom_template all sliders intros';
    $data['content']  = <<<CONTENT
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Slider Portfolio item SHOWCASE', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/sliders/original-showcase-portfolio-slider.png';
    $data['custom_class'] = 'custom_template_for_vc_custom_template all sliders intros';
    $data['content']  = <<<CONTENT
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Slider default boxed ELEMENTS', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/sliders/elements-slider-default-boxed.png';
    $data['custom_class'] = 'custom_template_for_vc_custom_template all sliders intros';
    $data['content']  = <<<CONTENT
...
CONTENT;
    ...
    $data = array();
    $data['name'] = __( 'Slider circles boxed ELEMENTS', 'pixfort-core' );
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
    $data['image_path'] = 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/sliders/elements-slider-circles-boxed.png';
    $data['custom_class'] = 'custom_template_for_vc_custom_template all sliders intros';
    $data['content']  = <<<CONTENT
