    ...
    function sc_pix_card($attr, $content = null) {
        ...
        if ($layout == 'small') {
            ...
            if (!empty($image)) {
                ...
                $output .= '<div class="pix-card-content">';
        ...
        if ($layout == 'big_padding') {
            $output .= '<div class="pix-content-box pix-card-element pix-card-content bg-white2 p-4 rounded-xl ' . $classes . '" ' . $anim_attrs . '>';
            if (!empty($image)) {
                $imgSrcset = '';
                ...
                $output .= '<div class="py-3">';
                    ...
                    $output .= '<p class="card-text ' . $text_classes . '" '.$text_style.'>' . $text . '</p>';
                $output .= '</div>';
                $output .= '<div class="card-footer text-right">';
                    $output .= '<a ' . $linkTarget . ' href="' . $link . '" '.$link_style.' class="d-flex align-items-center justify-content-end ' . $link_classes . '"><span class="d-inline-block">' . $link_text . '</span> <i class="pixicon-angle-right ml-2"></i></a>';
                $output .= '</div>';
            $output .= '</div>';
        }
        if ($layout == 'big') {
