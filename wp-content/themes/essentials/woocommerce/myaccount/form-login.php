...
<?php }else{ ?>
	...
	<?php } ?>
		...
		<form class=" woocommerce-form woocommerce-form-login pix-mb-80 shadow-lg bg-white login rounded-xl pix-p-30" method="post">
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' )  ) : ?>
	...
	<div class="col-12 col-md-6">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register pix-mb-80 shadow-lg bg-white rounded-xl pix-p-30" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
