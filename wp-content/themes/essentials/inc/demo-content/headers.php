...
function pixfort_demo_headers(){
    ...
    $demo = array(
        'import_file_name'             => 'Digital Agency Header',
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => $import_url.'demo-content/digital-agency/digital-agency-header.xml',
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-digital-agency.webp',
        'preview_url'                  => 'https://essentials.pixfort.com/digital-agency',
    );
    array_push($data, $demo);

    $demo = array(
        'import_file_name'             => 'Consulting Header',
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => $import_url.'demo-content/consulting/consulting-header.xml',
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-consulting.webp',
        'preview_url'                  => 'https://essentials.pixfort.com/consulting',
    );
    array_push($data, $demo);

    $demo = array(
        'import_file_name'             => 'Minimal Header',
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => $import_url.'demo-content/minimal/minimal-header.xml',
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-minimal.webp',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-company.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-gallery.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-modern.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-seo.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-fast.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-onepage.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-finance.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-original.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-software.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-saas.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-startup.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-marketing.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-kb.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-services.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-event.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-slides.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-medical.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-cryptocurrency.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-bold.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-creative.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-ebook.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-landing.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-restaurant.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-ecommerce.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-foundation.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-construction.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-business.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-corporate.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-product.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-coronavirus.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-personal.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-influencer.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-photography.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-app.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-agency.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-beauty.jpg',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/essentials/data/thumbnails/one_click/headers/header-blogger.jpg',
