(function ( $ ) {
    ...
    $.fn.stack = function() {
        ...
        $('.site-footer2').css({opacity: 1});
        $('.pix-footer-overlay, .sticky-overlay').css({opacity: 0});
        setTimeout(function(){
            $('.sticky-overlay').css({opacity: 0});
        },500);
        ...
        setTimeout(function(){
            window.pix_animation_display($('.pix-slides-section[data-number="0"]'));
            piximations.play($('.is-sticky-active'));
        }, 200);
    };
}( jQuery ));
(function ( $ ) {
            ...
            if(!$('body').hasClass('vc_editor')){
                $('.pix-scale-in, .pix-scale-in-xs, .pix-scale-in-sm, .pix-scale-in-lg').each(function(){
                    ...
                    document.addEventListener('scroll', 
                        window.handleScaleEvent = function (e) {
